...
public class SyntaxVerifier {
    ...
    /**
     * Enumeration for passing detailed info about password validity.
     */
     ...
     */
    public static PasswordValidity verifyPassword(String password) {
        if (password.length() > 5)
            return PasswordValidity.VALID;
        return PasswordValidity.INVALID_LENGTH;
    }
